...
public class ShopManagerUI {
	...
	// big button
	JCButton manageBookButton = new JCButton("商店管理", bookIcon, jf, null);

	// side bar element
	PersonLabel perLabel = new PersonLabel("商店管理员", adminIcon);
	...
	public ShopManagerUI() {
		...
		jf.setTitle("VCampus - 东南大学虚拟校园 - 商店管理员");
