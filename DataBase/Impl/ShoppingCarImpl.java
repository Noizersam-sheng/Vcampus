...
public class ShoppingCarImpl implements BaseDao, StudentDao {
  ...
  public ArrayList<ArrayList<String>> searchOneUser(String condition_name, String condition) {
    ...
    try {
      ...
      if (condition_name.equals("null") && condition.equals("null"))
        sql = "SELECT* FROM " + CarTableName;
      else
        sql = "SELECT* FROM " + CarTableName + " WHERE " + condition_name + " LIKE" + "'%" + condition + "%'"
  ...
  public static void main(String[] args) {
    ...
    String temp[] = { "213191246", "赖泽升", "JS1", "薯片", "乐事", "28.9", "10", "0.8", "2021-07-14", "100", "1" };
    // sl.updateUser(temp);
  }
}