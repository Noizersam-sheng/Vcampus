...
public class LogInImpl implements StudentDao, BaseDao {
  ...
  public static void main(String[] args) {
    ...
    String[] messages2 = { "2131", "null", "123456", "小刘", "5", "20", "1", "1985-07-03", "软件", "软件学院", "0" };
    ...
    // System.out.println(al);
    // System.out.println(li.searchAllUser("name"));
    // System.out.println(li.existUser("213191246", "小lai"));
  }
}